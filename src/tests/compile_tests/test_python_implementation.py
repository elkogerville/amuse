...
# TODO: raises an (ignored) exception:
# amuse.support.exceptions.CodeException: Exception when calling function
# '_stop_worker', of code 'ForTestingInterface', exception was 'MPI_ERR_COMM:
