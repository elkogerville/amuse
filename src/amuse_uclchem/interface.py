...
class uclchemInterface(CodeInterface):
    ...
    use_modules = ["uclchemInterface"]

    def __init__(self, **keyword_arguments):
        CodeInterface.__init__(self, name_of_the_worker="uclchem_worker", **keyword_arguments)
...
class uclchem(InCodeComponentImplementation):
    ...
    def __init__(self, **options):
        """Create a uclchem instance to run simulations with."""
        super().__init__(self,  uclchemInterface(**options), **options)
